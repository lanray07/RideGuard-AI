...
final class RideNotificationService {
    ...
    func schedule(_ ride: RideSession) async throws {
        ...
        content.title = ride.route.isDemo ? "Demo ride check-in" : "Everything okay?"
        content.body = "Your expected arrival has passed. Open RideGuard to check in or add more time."
