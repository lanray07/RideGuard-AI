    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                ...
                Text("Understand cycling route risk.").font(.largeTitle.bold())
                Panel {
                ...
                Panel {
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        ForEach(assessment.missingData, id: \.self) { Text("• \(L10n.text($0.title))").font(.subheadline).foregroundStyle(.secondary) }
...
struct ComparisonView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                Text("Compare cycling routes.").font(.largeTitle.bold())
